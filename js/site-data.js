...
window.SiteData = (function () {
  ...
  const gallery = [
    { id: "1", title: "Celestial Guardian", description: "Original character design inspired by celestial mythology.", category: "Character Designs", medium: "Digital", date: "2025-12-15", featured: true, oc: true },
    { id: "2", title: "Neon Dreamscape", description: "Cyberpunk cityscape at twilight.", category: "Illustrations", medium: "Digital", date: "2025-11-20", featured: true, oc: false },
    { id: "3", title: "Flora Spirit", description: "Nature spirit OC with botanical elements.", category: "Character Designs", medium: "Digital", date: "2025-10-08", featured: false, oc: true },
    { id: "4", title: "Warrior's Rest", description: "Fan art of a beloved RPG character.", category: "Fanart", medium: "Digital", date: "2025-09-22", featured: false, oc: false },
    { id: "5", title: "Moonlit Serenade", description: "Atmospheric illustration featuring moonlight and music.", category: "Illustrations", medium: "Mixed Media", date: "2025-08-30", featured: true, oc: false },
    { id: "6", title: "Shadow Weaver", description: "Dark fantasy OC who manipulates shadows.", category: "Character Designs", medium: "Digital", date: "2025-08-10", featured: false, oc: true },
    { id: "7", title: "Sakura Festival", description: "Fan art celebrating a seasonal anime event.", category: "Fanart", medium: "Digital", date: "2025-07-15", featured: false, oc: false },
    { id: "8", title: "Enchanted Forest", description: "Concept art for an indie game environment.", category: "Concept Art", medium: "Digital", date: "2025-06-25", featured: false, oc: false },
    { id: "9", title: "Aqua Regent", description: "Regal OC with water-based powers.", category: "Character Designs", medium: "Digital", date: "2025-06-01", featured: true, oc: true },
  ];
